...
<head>
    ...
    <title>Mise à jour des données sur les enseignants - Learnify</title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Les données mises à jour sur les étudiants incluent l'adresse e-mail et le nom complet.
                                    Nous ne pouvons pas changer le mot de passe de l'enseignant. Seul l'enseignant peut modifier le mot de passe.
                                    Seul.
                                </p>
