...
<head>
    ...
    <title>Tableau de bord d'administration - Learnify</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tableaux de bord</h1>
                    </div>
                    <div class="row">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Ajouter du matériel ?</h2>
                                <hr>
                                ...
                                <a href="<?= base_url('admin/tambah_materi') ?>" class="btn btn-success">Ajouter du matériel ⭢</a>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>ACCUEILLIR, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Après avoir croisé Helen dans un restaurant, j'ai réalisé qu'elle n'était qu'un rendez-vous au bureau mis dans une présentation pour notre stand-up d'aujourd'hui. Qui est responsable de cette demande ? mais déplacer les poteaux de but gagne du terrain.</p>
                                <div class="mt-4">
                                    <a href="<?= base_url('admin/data_siswa') ?>" class="btn btn-outline-white btn-lg btn-icon icon-left"><i class="far fa-user"></i>
                                    Données sur les étudiants</a>
                                </div>
                            </div>
                        </div>
                    </div>
