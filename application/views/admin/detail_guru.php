...
<head>
    ...
    <title>Données détaillées de l'enseignant - Learnify </title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    ...
                    <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                        ...
                        <p class="text-center" style="line-height: 5px;">Les données détaillées suivantes sont disponibles sur
                            base de données, y compris NIP, nom, email
                            et les matières enseignées.</p>
                        <hr>
                        <table style="width: 100%" class="container text-center">
                            <tbody>
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Numéro d'identification de l'employé :</span></td>
                                    <td> <?= $detail->nip ?></td>
                                </tr>
                                <tr style="border-bottom: 0.5px solid #6c757d;">
