...
<head>
    ...
    <title>Données sur les étudiants - Learnify</title>
    <!-- General CSS Files -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/tambah_materi') ?>">
...
Ajouter du matériel</a>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Learnify Gestion des données des étudiants</h2>
                            <hr>
                            ...
                            <a href="<?= base_url('user/registration') ?>" class="btn btn-success">Plus
                        ...
                        <div class="col-md-12">
                            <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                                <div class="table-responsive">
                                    <table id="example" class="table align-items-center table-flush">
                                        <thead class="thead-light">
                                            <tr class="text-center">
                                                <th scope="col">ID</th>
                                                <th scope="col">Nama SiswaNom de l'étudiant</th>
                                            ...
                                            ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/detail_siswa/' . $u->id); ?>" class="btn btn-success">Details ⭢</a>
                                                    </td>

                                                    <td class="text-center">
                                                        <a href="<?php echo site_url('admin/update_siswa/' . $u->id); ?>" class="btn btn-info">Modifier ⭢</a>
                                    ...
                                    <p class="small font-weight-bold">* Le chiffre 1 indique que le compte est actuellement actif
                                        Nombre
                                        0 indique un compte
                                        Pas encore
                                        actif</p>
