        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down" data-aos-duration="1400">Veuillez sélectionner une matière !
                    </h1>
                    <p>Bonjour les étudiants ! C'est la page principale des matières de Learnify ! Veuillez sélectionner la matière que vous souhaitez accéder et voilà, les vidéos et les documents sont prêts à être visionnés ! Bonne étude chers étudiants !</p>
                    <hr>
                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                                                                        ...
                                                                        $this->session->userdata('email')])->row_array();
                                                                        echo $data['user']['nama'];
                                                                        ?> - Étudiants de Learnify</h3>
                        <h5>Matières de la classe X</h5>
                </div>
            </div>
        </div>
    </div>
