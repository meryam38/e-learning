...
<head>
    ...
    <title>Étude de la religion islamique | Classe de X - Learnify</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item active"><a class="nav-link" href="<?= base_url('user') ?>">Page d'accueil</a>
                            </li>
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    <h1 class="display-4" data-aos="fade-down" data-aos-duration="1400">Veuillez choisir le matériel que vous
                    souhaitez étudier !
                    </h1>
                    ...
                    <p>Étude de la religion islamique - Classe de X</p>
                    <hr width="80%">
                    <p data-aos="fade-down" class="font-weight-bold" data-aos-duration="1800">Veuillez choisir le matériel que
                    vous
                    souhaitez accéder ci-dessous!
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 mb-4" data-aos="fade-right" data-aos-duration="1200">
                    <div class="card materi w-150 border-0">
                        <div class="card-body p-5">
                            ...
                            <a href="<?php echo site_url('materi/belajar/' . $u->id); ?>" class="btn btn-white">Étudier
                            Maintenant !</a>
                        </div>
                    </div>
                </div>
